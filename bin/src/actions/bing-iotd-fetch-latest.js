...
export class bingIotdFetchLatest {
    ...
    command = "bing-iotd-fetch-latest";
    description = "Fetch latest images of the day from bing";
}
//# sourceMappingURL=bing-iotd-fetch-latest.js.map